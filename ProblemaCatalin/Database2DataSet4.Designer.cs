...
namespace ProblemaCatalin {
    ...
    public partial class Database2DataSet4 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int studentId, string Nume, string Prenume, string Localitatea, string Strada, string Bloc, string Apartament, string Tara, string Facultatea) {
            ...
            private void InitClass() {
                ...
                this.columnApartament.MaxLength = 100;
                this.columnTara.AllowDBNull = false;
                this.columnTara.MaxLength = 100;
                this.columnFacultatea.AllowDBNull = false;
                this.columnFacultatea.MaxLength = 100;
...
namespace ProblemaCatalin.Database2DataSet4TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table] ([studentId], [Nume], [Prenume], [Localitatea], [Strada], [Bloc], [Apartament], [Tara], [Facultatea]) VALUES (@studentId, @Nume, @Prenume, @Localitatea, @Strada, @Bloc, @Apartament, @Tara, @Facultatea);
SELECT studentId, Nume, Prenume, Localitatea, Strada, Bloc, Apartament, Tara, Facultatea FROM [Table] WHERE (studentId = @studentId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [studentId] = @studentId, [Nume] = @Nume, [Prenume] = @Prenume, [Localitatea] = @Localitatea, [Strada] = @Strada, [Bloc] = @Bloc, [Apartament] = @Apartament, [Tara] = @Tara, [Facultatea] = @Facultatea WHERE (([studentId] = @Original_studentId) AND ([Nume] = @Original_Nume) AND ([Prenume] = @Original_Prenume) AND ([Localitatea] = @Original_Localitatea) AND ([Strada] = @Original_Strada) AND ([Bloc] = @Original_Bloc) AND ([Apartament] = @Original_Apartament) AND ([Tara] = @Original_Tara) AND ([Facultatea] = @Original_Facultatea));
SELECT studentId, Nume, Prenume, Localitatea, Strada, Bloc, Apartament, Tara, Facultatea FROM [Table] WHERE (studentId = @studentId)";
        ...
        public virtual int Insert(int studentId, string Nume, string Prenume, string Localitatea, string Strada, string Bloc, string Apartament, string Tara, string Facultatea) {
            ...
            if ((Apartament == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[6].Value = ((string)(Apartament));
            }
            if ((Tara == null)) {
            ...
            if ((Facultatea == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[8].Value = ((string)(Facultatea));
            }
        ...
        public virtual int Update(
            ...
            if ((Apartament == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Apartament));
            }
            if ((Tara == null)) {
                throw new global::System.ArgumentNullException("Tara");
            }
            ...
            if ((Facultatea == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Facultatea));
            }
            ...
            if ((Original_Localitatea == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_Localitatea));
            }
            if ((Original_Strada == null)) {
                throw new global::System.ArgumentNullException("Original_Strada");
            }
            ...
            if ((Original_Apartament == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_Apartament));
            }
            if ((Original_Tara == null)) {
                throw new global::System.ArgumentNullException("Original_Tara");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(Original_Tara));
            }
            if ((Original_Facultatea == null)) {
                throw new global::System.ArgumentNullException("Original_Facultatea");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[17].Value = ((string)(Original_Facultatea));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_Tara, 
                    string Original_Facultatea) {
            return this.Update(Original_studentId, Nume, Prenume, Localitatea, Strada, Bloc, Apartament, Tara, Facultatea, Original_studentId, Original_Nume, Original_Prenume, Original_Localitatea, Original_Strada, Original_Bloc, Original_Apartament, Original_Tara, Original_Facultatea);
        }
    }
